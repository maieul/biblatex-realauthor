...
Used in a bibliography macro or driver, \cmd{ifuserealauthor}\mprm{true}\mprem{false} expands to \prm{true} if the \opt{userealauthor} option is enabled (either globally or for the current entry), and \prm{false} otherwise.
...
\begin{changelog}
  ...
  \begin{release}{2.2.0}{2015-02-xxx}
