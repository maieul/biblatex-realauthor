...
You can also redefine the \cmd{realauthorequalsign} command to change the signe before the real author name when a pseudonym is also used. Default value is:

\begin{minted}{tex}
\newcommand{\realauthorequalsign}{\,=\,}
\end{minted}
